...
const analyticsContracts = {
  ...
  article_read_50: { targetPattern: /^[A-Za-z0-9_-]{1,100}$/, placements: new Set(['article_page']) },
  article_read_90: { targetPattern: /^[A-Za-z0-9_-]{1,100}$/, placements: new Set(['article_page']) },
  article_exit: { targetPattern: /^[A-Za-z0-9_-]{1,100}$/, placements: new Set(['early_exit', 'normal_exit']) },
  article_cls: { targetPattern: /^(?:0|[0-9]+\.[0-9]{3})$/, placements: new Set(['article_page']) },
  ...
  home_section_impression: { targets: new Set(['editorial', 'major', 'latest', 'books', 'guide']), placements: new Set(['home']) },
  ...
  book_reader_view: { targetPattern: /^[A-Za-z0-9가-힣_-]{1,120}$/, placements: new Set(['book_reader']) },
  book_read_25: { targetPattern: /^[A-Za-z0-9가-힣_-]{1,120}$/, placements: new Set(['book_reader']) },
  book_read_50: { targetPattern: /^[A-Za-z0-9가-힣_-]{1,120}$/, placements: new Set(['book_reader']) },
  book_read_75: { targetPattern: /^[A-Za-z0-9가-힣_-]{1,120}$/, placements: new Set(['book_reader']) },
  book_read_100: { targetPattern: /^[A-Za-z0-9가-힣_-]{1,120}$/, placements: new Set(['book_reader']) },
  book_purchase_cta_click: { targetPattern: /^[A-Za-z0-9가-힣_-]{1,120}$/, placements: new Set(['book_hero_v2', 'book_lockwall', 'book_closing_v2']) },
...
function matchesContract(contract, target, placement) {
  ...
  if (contract.placements && !contract.placements.has(placement)) return false;
  if (contract.placementPattern && !contract.placementPattern.test(placement)) return false;
  if (!contract.placements && !contract.placementPattern) return false;
