...
assert.equal(glossary.terms.length, 12, 'Learn Mode V0.1 must ship exactly 12 core terms');
...
console.log('Treasury Learn Mode V0.1 contract PASS: 12 terms, toggle, panel, persistence, related research.');
